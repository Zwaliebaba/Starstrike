...
void LaserFence::Spark()
{
    ...
    for( int i = 0; i < numSparks; ++i )
    {
        ...
        else            particleVel = LegacyVector3( sfrand(10.0f), sfrand(5.0f), sfrand(10.0f) );
...
void LaserFence::Electrocute( LegacyVector3 const &_pos )
{
    g_app->m_soundSystem->TriggerBuildingEvent( this, "Electrocute" );
}


bool LaserFence::DoesSphereHit(LegacyVector3 const &_pos, float _radius)
{
...
bool LaserFence::DoesRayHit(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayDir,
