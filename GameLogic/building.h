...
public:
    ...
    LegacyVector3 PushFromBuilding( LegacyVector3 const &_pos, float _radius );
    ...
    virtual bool DoesSphereHit          (LegacyVector3 const &_pos, float _radius);
    virtual bool DoesShapeHit           (Shape *_shape, Matrix34 _transform);
    virtual bool DoesRayHit             (LegacyVector3 const &_rayStart, LegacyVector3 const &_rayDir,
