...
void Entity::Attack( LegacyVector3 const &pos )
{
    if( m_reloading == 0.0f )
    {
		LegacyVector3 toPos( pos.x + syncsfrand(15.0f),
					   pos.y,
...
LegacyVector3 Entity::PushFromEachOther( LegacyVector3 const &_pos )
{
...
LegacyVector3 Entity::PushFromCliffs( LegacyVector3 const &pos, LegacyVector3 const &oldPos )
{
...
LegacyVector3 Entity::PushFromObstructions( LegacyVector3 const &pos, bool killem )
{
    LegacyVector3 result = pos;
    if( m_onGround )
    {
...
void Entity::RenderShadow( LegacyVector3 const &_pos, float _size )
{
    LegacyVector3 shadowPos = _pos;
    LegacyVector3 shadowR = LegacyVector3(_size,0,0);
    LegacyVector3 shadowU = LegacyVector3(0,0,_size);
...
bool Entity::RayHit(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayDir)
{
	if (m_shape)
	{
...
LegacyVector3 Entity::GetCameraFocusPoint()
{
	return m_pos + m_vel;
}

void Entity::SetWaypoint( LegacyVector3 const _waypoint )
{
}
