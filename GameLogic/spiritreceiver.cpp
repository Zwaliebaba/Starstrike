...
void ReceiverBuilding::RenderUnprocessedSpirit( LegacyVector3 const &_pos, float _life )
{
...
void ReceiverBuilding::RenderUnprocessedSpirit_basic( LegacyVector3 const &_pos, float _life )
{
	LegacyVector3 position = _pos;
	LegacyVector3 camUp = g_app->m_camera->GetUp();
	LegacyVector3 camRight = g_app->m_camera->GetRight();
...
void ReceiverBuilding::RenderUnprocessedSpirit_detail( LegacyVector3 const &_pos, float _life )
{
	LegacyVector3 position = _pos;
	LegacyVector3 camUp = g_app->m_camera->GetUp();
	LegacyVector3 camRight = g_app->m_camera->GetRight();
