...
InsertionSquad::InsertionSquad( int teamId, int unitId, int numEntities, LegacyVector3 const &_pos )
...
void InsertionSquad::SetWayPoint(LegacyVector3 const &_pos)
{
	m_wayPoint = _pos;
...
void Squadie::Attack( LegacyVector3 const &_pos )
{
    if( m_reloading == 0.0f )
    {
        //
