...
public:
    void Render( int realX, int realY, bool highlighted, bool clicked )
    {
        ...
        LegacyVector3 soundPos = g_app->m_soundSystem->m_editorPos;
...
void SoundEditorWindow::Render( bool hasFocus )
{
    ...
    for( int i = 0; i < g_app->m_soundSystem->m_numChannels; ++i )
    {
            ...
            instance->m_positionType != SoundInstance::TypeInEditor )
        {
            ...
            LegacyVector3 up = g_app->m_camera->GetUp() * size * 0.5f;
            LegacyVector3 right = g_app->m_camera->GetRight() * size * -0.5f;
            ...
            LegacyVector3 pos = instance->m_pos;
