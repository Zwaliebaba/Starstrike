...
LegacyVector3 FeedingTube::GetForwardsClippingDir( float _predictionTime, FeedingTube *_sender )
{
	...
	LegacyVector3 combinedDirection =
		-senderDishFront +
		dishFront;
...
LegacyVector3 FeedingTube::GetStartPoint()
{
    return GetDishPos(0.0f);
}


LegacyVector3 FeedingTube::GetEndPoint()
{
...
bool FeedingTube::DoesSphereHit(LegacyVector3 const &_pos, float _radius)
{
