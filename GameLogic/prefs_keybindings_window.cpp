...
static ControlName s_controls[] = {
  ControlCameraLeft, false, "control_event_left", ControlCameraRight, false, "control_event_right", ControlCameraForwards, false,
  "control_event_forwards", ControlCameraBackwards, false, "control_event_backwards", ControlCameraUp, false, "control_event_up",
  ControlCameraDown, false, "control_event_down", ControlCameraZoom, false, "control_event_zoom", ControlUnitDeselect, true,
  "control_event_deselect", ControlSkipMessage, true, "control_event_skipmessage", ControlGesturesChatLog, true, "control_event_chatlog",
  ControlIconsChatLog, true, "control_event_iconschatlog", ControlIconsTaskManagerDisplay, true, "control_event_iconstaskmanagerdisplay",
  ControlIconsTaskManagerEndTask, true, "control_event_iconstaskmanagerendtask", ControlNull, false, nullptr
};
