...
public:
    ...
    virtual void Attack             ( LegacyVector3 const &pos );

    virtual bool IsInView ();

	virtual void SetWaypoint( LegacyVector3 const _waypoint );

    virtual LegacyVector3 PushFromObstructions( LegacyVector3 const &pos, bool killem = true );
    virtual LegacyVector3 PushFromCliffs      ( LegacyVector3 const &pos, LegacyVector3 const &oldPos );
    virtual LegacyVector3 PushFromEachOther   ( LegacyVector3 const &_pos );
    ...
    static void     RenderShadow        ( LegacyVector3 const &_pos, float _size );
	...
	bool RayHit(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayDir);
