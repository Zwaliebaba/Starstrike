...
bool StaticShape::DoesRayHit(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayDir,
...
bool StaticShape::DoesSphereHit(LegacyVector3 const &_pos, float _radius)
{
    if(m_shape)
    {
