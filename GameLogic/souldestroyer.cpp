...
void SoulDestroyer::Attack( LegacyVector3 const &_pos )
{
    int numFound;
...
bool SoulDestroyer::SearchForRandomPosition()
{
    ...
    else
    {
        ...
        m_targetPos = m_pos + LegacyVector3( sinf(angle) * distance,
                                       0.0f,
                                       cosf(angle) * distance );
...
void SoulDestroyer::RenderSpirit( LegacyVector3 const &_pos, float _alpha )
{
...
void SoulDestroyer::SetWaypoint( const LegacyVector3 _waypoint )
{
