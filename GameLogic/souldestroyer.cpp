...
void SoulDestroyer::Render(float _predictionTime)
{
  ...
  if (!m_dead)
  {
    ...
    //        RenderArrow( m_pos, m_pos+predictedFront * 200.0f, 3.0f, RGBAColor(0,255,0) );
    //        RenderArrow( m_pos, m_pos+predictedUp * 100.0f, 2.0f, RGBAColor(255,0,0) );
    //        RenderArrow( m_pos, m_pos+predictedRight * 100.0f, 2.0f, RGBAColor(0,0,255) );
