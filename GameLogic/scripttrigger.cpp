...
bool ScriptTrigger::DoesSphereHit(LegacyVector3 const &_pos, float _radius)
{
    return false;
}
...
bool ScriptTrigger::DoesRayHit(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayDir,
