...
bool Tree::Advance()
{
    ...
    if( m_onFire > 0.0f )
    {
        ...
        for( int i = 0; i < numFire; ++i )
        {
            ...
            fireSpawn += LegacyVector3( sfrand(actualHeight*1.0f),
        ...
        {
            LegacyVector3 fireSpawn = m_pos + LegacyVector3(0,actualHeight,0);
            fireSpawn += LegacyVector3( sfrand(actualHeight*0.75f),
...
bool Tree::DoesSphereHit(LegacyVector3 const &_pos, float _radius)
{
...
bool Tree::DoesRayHit(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayDir,
                      float _rayLen, LegacyVector3 *_pos, LegacyVector3 *_norm)
{
...
void Tree::RenderBranch( LegacyVector3 _from, LegacyVector3 _to, int _iterations,
                         bool _calcRadius, bool _renderBranch, bool _renderLeaf )
{
    ...
    */
    ...
    for( int i = 0; i < numBranches; ++i )
    {
        ...
        LegacyVector3 thisTo = thisFrom + thisRightAngle * thickness * 0.4f * m_pushOut
