...
ThrowableWeapon::ThrowableWeapon( int _type, LegacyVector3 const &_startPos, LegacyVector3 const &_front, float _force )
:   m_shape(NULL),
    m_force(1.0f),
    m_numFlashes(0)
{
...
Grenade::Grenade( LegacyVector3 const &_startPos, LegacyVector3 const &_front, float _force )
...
AirStrikeMarker::AirStrikeMarker( LegacyVector3 const &_startPos, LegacyVector3 const &_front, float _force )
...
ControllerGrenade::ControllerGrenade( LegacyVector3 const &_startPos, LegacyVector3 const &_front, float _force )
...
MuzzleFlash::MuzzleFlash( LegacyVector3 const &_pos, LegacyVector3 const &_front, float _size, float _life )
:   WorldObject(),
    m_front(_front),
    m_size(_size),
    m_life(_life)
...
bool Missile::AdvanceToTargetPosition( LegacyVector3 const &_pos )
{
