...
void Armour::SetOrders( LegacyVector3 const &_orders )
{
    m_newOrdersTimer = 0.0f;
...
void Armour::SetWayPoint( LegacyVector3 const &_wayPoint )
{
...
void Armour::SetConversionPoint ( LegacyVector3 const &_conversionPoint )
{
    m_conversionPoint.Zero();
