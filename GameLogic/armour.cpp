...
void Armour::Render(float _predictionTime)
{
  ...
  {
  case StateIdle:
    m_flag.SetTexture(g_app->m_resource->GetTexture("icons/banner_none.bmp"));
    break;
  case StateUnloading:
    m_flag.SetTexture(g_app->m_resource->GetTexture("icons/banner_unload.bmp"));
    break;
  case StateLoading:
    m_flag.SetTexture(g_app->m_resource->GetTexture("icons/banner_follow.bmp"));
    break;
  }
