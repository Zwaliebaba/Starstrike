...
void Officer::RenderSpirit( LegacyVector3 const &_pos )
{
...
void Officer::SetWaypoint( LegacyVector3 const &_wayPoint )
{
...
void Officer::SetOrders( LegacyVector3 const &_orders )
{
