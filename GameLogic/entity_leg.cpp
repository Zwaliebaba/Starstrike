    ...
    m_parent(_parent)
{
  ...
  DarwiniaReleaseAssert(m_shapeUpper, "EntityLeg: Couldn't load leg shape {}", _shapeNameUpper);
  DarwiniaReleaseAssert(m_shapeLower, "EntityLeg: Couldn't load leg shape {}", _shapeNameLower);
