...
/*
        ...
        LegacyVector3 dif( m_size * sinf(angle), 0.0f, m_size * cosf(angle) );

        LegacyVector3 pos = m_pos + dif;
...
*/
    ...
    //g_editorFont.DrawText3DCentre( m_pos + LegacyVector3(0,m_size/2,0), 10.0f, "%d / %d %ss", m_entitiesCounted, m_entitiesRequired, entityTypeRequired );
}


bool SafeArea::DoesSphereHit(LegacyVector3 const &_pos, float _radius)
{
    return false;
}
...
bool SafeArea::DoesRayHit(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayDir,
