...
class Physical
{
  public:
    ...
    Point Acceleration() const { return accel; }
    ...
    virtual void SetDrag(double d) { drag = static_cast<float>(d); }
  ...
  protected:
    ...
    inline static double sub_frame = 1.0 / 60.0;
};
