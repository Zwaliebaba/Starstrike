...
Locale::~Locale() { locales.remove(this); }
...
Locale* Locale::CreateLocale(const char* l, const char* c, const char* v)
{
...
const List<Locale>& Locale::GetAllLocales() { return locales; }

const std::string Locale::GetFullCode() const
{
...
const std::string Locale::GetDisplayName() const
{
  std::string result;
  if (*language)
  {
