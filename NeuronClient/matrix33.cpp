...
Matrix33::Matrix33( LegacyVector3 const &_r, LegacyVector3 const &_u, LegacyVector3 const &_f )
:	r(_r),
	u(_u),
	f(_f)
{
...
void Matrix33::OrientRU( LegacyVector3 const & _r, LegacyVector3 const & _u )
{
	LegacyVector3 tr = _r;
	tr.Normalise();
	f = tr ^ _u;
...
void Matrix33::OrientRF( LegacyVector3 const & _r, LegacyVector3 const & _f )
{
	LegacyVector3 tr = _r;
	tr.Normalise();
	u = _f ^ tr;
...
void Matrix33::OrientUF( LegacyVector3 const & _u, LegacyVector3 const & _f )
{
	LegacyVector3 tu = _u;
	tu.Normalise();
	r = tu ^ _f;
...
void Matrix33::OrientUR( LegacyVector3 const & _u, LegacyVector3 const & _r )
{
	LegacyVector3 tu = _u;
	tu.Normalise();
	f = _r ^ tu;
...
void Matrix33::OrientFR( LegacyVector3 const & _f, LegacyVector3 const & _r )
{
	LegacyVector3 tf = _f;
	tf.Normalise();
	u = tf ^ _r;
...
void Matrix33::OrientFU( LegacyVector3 const & _f, LegacyVector3 const & _u )
{
	LegacyVector3 tf = _f;
	tf.Normalise();
	r = _u ^ tf;
...
Matrix33 const &Matrix33::RotateAround( LegacyVector3 const &_rotationAxis )
{
...
Matrix33 const &Matrix33::FastRotateAround( LegacyVector3 const & _norm, float _angle )
{
...
Matrix33 const &Matrix33::RotateAround( LegacyVector3 const & _onorm, float _angle )
{
...
LegacyVector3	Matrix33::InverseMultiplyVector(LegacyVector3 const &s) const
{
	LegacyVector3 const &v = s;
	return LegacyVector3(r.x*v.x + u.x*v.y + f.x*v.z,
