...
XMFLOAT4X4 Matrix33::ToXMFLOAT4X4(const LegacyVector3* _pos) const
{
  return XMFLOAT4X4(r.x, r.y, r.z, 0.0f, u.x, u.y, u.z, 0.0f, f.x, f.y, f.z, 0.0f, _pos ? _pos->x : 0.f, _pos ? _pos->y : 0.f,
                    _pos ? _pos->z : 0.f, 1.0f);
}
