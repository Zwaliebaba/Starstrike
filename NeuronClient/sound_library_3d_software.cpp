												...
												float *_left, float *_right)
{
	...
	{
		LegacyVector3 to = channel->m_pos - m_listenerPos;
		float dist = to.Mag();
		to /= dist;
...
void SoundLibrary3dSoftware::SetChannelPosition( int _channel, LegacyVector3 const &_pos, LegacyVector3 const &_vel )
{
...
void SoundLibrary3dSoftware::SetListenerPosition( LegacyVector3 const &_pos,
                                        LegacyVector3 const &_front,
                                        LegacyVector3 const &_up,
                                        LegacyVector3 const &_vel )
{
	m_listenerPos = _pos;
