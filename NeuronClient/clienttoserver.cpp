...
void ClientToServer::RequestCreateUnit(unsigned char _teamId, unsigned char _troopType, int _numToCreate, const LegacyVector3& _pos)
{
  auto letter = new NetworkUpdate();
  letter->SetType(NetworkUpdate::CreateUnit);
  letter->SetTeamId(_teamId);
...
void ClientToServer::RequestAimBuilding(unsigned char _teamId, int _buildingId, const LegacyVector3& _pos)
{
  auto letter = new NetworkUpdate();
...
void ClientToServer::RequestTargetProgram(unsigned char _teamId, unsigned char _program, const LegacyVector3& _pos)
{
  auto letter = new NetworkUpdate();
