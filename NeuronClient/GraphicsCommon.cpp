...
{
  SamplerDesc SamplerLinearWrapDesc = { D3D12_COMPARISON_FUNC_NONE };
  SamplerDesc SamplerAnisoWrapDesc = { D3D12_COMPARISON_FUNC_NONE };
  SamplerDesc SamplerShadowDesc = { D3D12_COMPARISON_FUNC_NONE };
  SamplerDesc SamplerLinearClampDesc = { D3D12_COMPARISON_FUNC_NONE };
  SamplerDesc SamplerVolumeWrapDesc = { D3D12_COMPARISON_FUNC_NONE };
  SamplerDesc SamplerPointClampDesc = { D3D12_COMPARISON_FUNC_NONE };
  SamplerDesc SamplerPointBorderDesc;
  SamplerDesc SamplerLinearBorderDesc = { D3D12_COMPARISON_FUNC_NONE };
...
void Graphics::InitializeCommonState()
{
  ...
  SamplerLinearBorderDesc.SetBorderColor(Color::BLACK);
  ...
  SamplerPointBorderDesc.SetBorderColor(Color::BLACK);
