...
public:
	...
	void PointMarker(LegacyVector3 const &_point, unsigned int _life, char *_text, ...);
	void Sphere(LegacyVector3 const &_centre, float _radius, int _life, char *_text, ...);
	void Vector(LegacyVector3 const &_start, LegacyVector3 const &_end, int _life, char *_text, ...);
