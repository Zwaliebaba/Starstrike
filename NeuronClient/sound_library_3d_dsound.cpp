...
void SoundLibrary3dDirectSound::SetChannelPosition( int _channel, LegacyVector3 const &_pos, LegacyVector3 const &_vel )
{
	DirectSoundChannel *channel;
	if (_channel == m_musicChannelId) channel = m_musicChannel;
	else				channel = &m_channels[_channel];
...
void SoundLibrary3dDirectSound::SetListenerPosition( LegacyVector3 const &_pos,
