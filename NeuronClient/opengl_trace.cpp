...
void glTraceEnable(bool _enable) { g_tracingOpenGL = _enable; }

void glTrace(const char* _fmt, ...)
{
  static FILE* output = nullptr;
  static unsigned line_number = 0;
  constexpr unsigned MAX_LINES = 50000;
...
const char* glBooleanToString(bool value) { return value ? "TRUE" : "FALSE"; }
