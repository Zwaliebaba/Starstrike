...
void Matrix34::OrientRU( LegacyVector3 const & _r, LegacyVector3 const & _u )
{
	LegacyVector3 tr = _r;
	tr.Normalise();
	f = tr ^ _u;
...
void Matrix34::OrientRF( LegacyVector3 const & _r, LegacyVector3 const & _f )
{
	LegacyVector3 tr = _r;
	tr.Normalise();
	u = _f ^ tr;
...
void Matrix34::OrientUF( LegacyVector3 const & _u, LegacyVector3 const & _f )
{
	LegacyVector3 tu = _u;
	tu.Normalise();
	r = tu ^ _f;
...
void Matrix34::OrientUR( LegacyVector3 const & _u, LegacyVector3 const & _r )
{
	LegacyVector3 tu = _u;
	tu.Normalise();
	f = _r ^ tu;
...
void Matrix34::OrientFR( LegacyVector3 const & _f, LegacyVector3 const & _r )
{
	LegacyVector3 tf = _f;
	tf.Normalise();
	u = tf ^ _r;
...
void Matrix34::OrientFU( LegacyVector3 const & _f, LegacyVector3 const & _u )
{
	LegacyVector3 tf = _f;
	tf.Normalise();
	r = _u ^ tf;
...
Matrix34 const &Matrix34::RotateAround( LegacyVector3 const &_rotationAxis )
{
...
Matrix34 const &Matrix34::FastRotateAround( LegacyVector3 const & _norm, float _angle )
{
...
Matrix34 const &Matrix34::RotateAround( LegacyVector3 const & _onorm, float _angle )
{
...
LegacyVector3	Matrix34::InverseMultiplyVector(LegacyVector3 const &s) const
{
