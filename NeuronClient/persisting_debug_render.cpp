...
PersistRenderItem* PersistingDebugRenderer::FindItem(const char* _label)
{
...
void PersistingDebugRenderer::PointMarker(const LegacyVector3& _point, unsigned int _life, char* _fmt, ...)
{
  char buf[512];
  va_list ap;
  va_start(ap, _fmt);
...
void PersistingDebugRenderer::Sphere(const LegacyVector3& _centre, float _radius, int _life, char* _fmt, ...)
{
  char buf[512];
  va_list ap;
  va_start(ap, _fmt);
...
void PersistingDebugRenderer::Vector(const LegacyVector3& _start, const LegacyVector3& _end, int _life, char* _fmt, ...)
{
  char buf[512];
  va_list ap;
  va_start(ap, _fmt);
