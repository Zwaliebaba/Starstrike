...
void PersistingDebugRenderer::PointMarker(LegacyVector3 const &_point, unsigned int _life, char *_fmt, ...)
{
    char buf[512];
    va_list ap;
    va_start (ap, _fmt);
...
void PersistingDebugRenderer::Sphere(LegacyVector3 const &_centre, float _radius, int _life, char *_fmt, ...)
{
    char buf[512];
    va_list ap;
    va_start (ap, _fmt);
...
void PersistingDebugRenderer::Vector(LegacyVector3 const &_start, LegacyVector3 const &_end, int _life, char *_fmt, ...)
{
    char buf[512];
    va_list ap;
    va_start (ap, _fmt);
