...
void ShapeFragment::WriteToFile(FILE *_out) const
{
	...
	if (stricmp(m_name, "SceneRoot") != 0)
	{
		...
		{
			LegacyVector3 const &v = m_positions[i];
		...
		{
			LegacyVector3 const &n = m_normals[i];
...
{
	LegacyVector3 *positions = new LegacyVector3[_numPositions];
...
void ShapeFragment::CalculateCentre( Matrix34 const &_transform, LegacyVector3 &_centre, int &_numFragments )
{
	Matrix34 totalMatrix = m_transform * _transform;
	LegacyVector3 centre = totalMatrix * m_centre;
...
void ShapeFragment::CalculateRadius( Matrix34 const &_transform, LegacyVector3 const &_centre, float &_radius )
{
	Matrix34 totalMatrix = m_transform * _transform;
	LegacyVector3 centre = totalMatrix * m_centre;
...
LegacyVector3 Shape::CalculateCentre( Matrix34 const &_transform )
{
...
float Shape::CalculateRadius( Matrix34 const &_transform, LegacyVector3 const &_centre )
{
    float radius = 0.0f;
