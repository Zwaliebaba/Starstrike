...
public:
    ...
    virtual void SetChannelPosition (int _channel, LegacyVector3 const &_pos, LegacyVector3 const &_vel) = 0;
    ...
    virtual void SetListenerPosition(LegacyVector3 const &_pos, LegacyVector3 const &_front,
									 LegacyVector3 const &_up, LegacyVector3 const &_vel) = 0;
