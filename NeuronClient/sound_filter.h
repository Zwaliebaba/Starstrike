...
class DspEffect
{
  ...
  public:
    DspEffect(int _sampleRate)
      : m_sampleRate(_sampleRate) {}

    virtual ~DspEffect() {};

    virtual void SetParameters(const float* _params) = 0;
...
class DspResLowPass : public DspEffect
{
  ...
  public:
    ...
    void SetParameters(const float* _params) override;
    void Process(signed short* _data, unsigned int _numSamples) override;
};
