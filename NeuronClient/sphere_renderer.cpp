...
// * Class Triangle *
// ******************
Triangle::Triangle( LegacyVector3 const &c1, LegacyVector3 const &c2, LegacyVector3 const &c3 )
{
	m_corner[0] = c1;
	m_corner[1] = c2;
	m_corner[2] = c3;
...
Sphere::Sphere()
{
	...
	c[1] = LegacyVector3( x, 0, z);
	c[2] = LegacyVector3(-x, 0,-z);
	c[3] = LegacyVector3( x, 0,-z);
	c[4] = LegacyVector3( 0, z, x);
	c[5] = LegacyVector3( 0, z,-x);
	c[6] = LegacyVector3( 0,-z, x);
	c[7] = LegacyVector3( 0,-z,-x);
	c[8] = LegacyVector3( z, x, 0);
	c[9] = LegacyVector3(-z, x, 0);
	c[10] = LegacyVector3( z,-x, 0);
	c[11] = LegacyVector3(-z,-x, 0);
...
void Sphere::ConsiderTriangle(int level, LegacyVector3 const &a, LegacyVector3 const &b, LegacyVector3 const &c)
{
	...
	else
	{
		...
		LegacyVector3 p = (a + b).Normalise();
		LegacyVector3 q = (b + c).Normalise();
		LegacyVector3 r = (c + a).Normalise();
