...
public:
    ...
    void Initialise(LegacyVector3 const &_pos, LegacyVector3 const &_vel,
...
public:
	...
	void CreateParticle(LegacyVector3 const &_pos, LegacyVector3 const &_vel,
						int _particleTypeId, float _size=-1.0f, RGBAColour col = RGBAColour(0) );
