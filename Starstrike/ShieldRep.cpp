...
constexpr int MAX_SHIELD_HITS = 16;
...
ShieldRep::~ShieldRep() { delete [] hits; }

void ShieldRep::Hit(Vec3 impact, Shot* shot, double damage)
{
...
void ShieldRep::Energize(double seconds, bool b)
{
  bubble = b;
...
void ShieldRep::TranslateBy(const Point& ref)
{
  true_eye_point = ref;
...
void ShieldRep::Render(Video* video, DWORD flags)
{
