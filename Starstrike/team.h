...
public:
	...
	Entity *RayHitEntity(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayEnd);
    Unit   *GetMyUnit   ();
    Entity *GetMyEntity ();
    Unit   *NewUnit     (int _troopType, int _numEntities, int *_unitId, LegacyVector3 const &_pos);
