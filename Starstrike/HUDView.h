...
class HUDView : public View, public SimObserver
{
  ...
  protected:
    std::string FormatInstruction(const std::string& instr);
    ...
    void DrawHUDText(int index, std::string_view txt, Rect& rect, int align, int upcase = HUD_UPPER_CASE, bool box = false);
