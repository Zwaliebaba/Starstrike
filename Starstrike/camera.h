...
protected:
	...
	float DistanceToBlockage(LegacyVector3 const &_dir, float _maxDist);
	float DirectDistanceToBlockage(LegacyVector3 const &_from, LegacyVector3 const &_to, float const _maxDist);
    void GetHighestPoint( LegacyVector3 const &_from, LegacyVector3 const &_to, float _maxDist, LegacyVector3 &location );
	void GetHighestTangentPoint( LegacyVector3 const &_from, LegacyVector3 const &_to, float _maxDist, LegacyVector3 &location );
...
public:
	...
	void SetTarget		(LegacyVector3 const &_pos, LegacyVector3 const &_front, LegacyVector3 const &_up=g_upVector);
	bool SetTarget		(char const *_mountName); // Returns false if mount not found
    void SetTarget      (LegacyVector3 const &_focusPos, float _distance, float _height );
    ...
    void Get2DScreenPos (LegacyVector3 const &_vector, float *_screenX, float *_screenY);
