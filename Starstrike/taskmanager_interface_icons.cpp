...
void TaskManagerInterfaceIcons::RenderTooltip()
{
  ...
  //
  //        char *toolTip = Strings::Get("newcontrols_hidetaskmanager");
...
void TaskManagerInterfaceIcons::RenderMessages()
{
  if (m_currentMessageType != -1)
  {
    ...
    if (m_currentTaskType == 999)
      taskName = Strings::Get("taskmanager_mapeditor");
    else if (m_currentTaskType == 998)
      taskName = Strings::Get("taskmanager_accessallareas");
...
void TaskManagerInterfaceIcons::RenderTaskManager()
{
  ...
  //g_gameFont.DrawText2DDown(m_screenW - 65, 100, 45, Strings::Get("taskmanager_taskmanager"));
  //g_gameFont.SetRenderOutline(false);
  glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
  //g_gameFont.DrawText2DDown(m_screenW - 65, 100, 45, Strings::Get("taskmanager_taskmanager"));
...
void TaskManagerInterfaceIcons::RenderOverview()
{
  ...
  g_gameFont.SetRenderShadow(true);
  glColor4ub(255, 255, 150, 30);
  g_gameFont.DrawText2DCenter(screenCenter - boxW, 105, 12, Strings::Get("taskmanager_research"));
  g_gameFont.DrawText2DCenter(screenCenter, 105, 12, Strings::Get("taskmanager_taskmanager"));
  g_gameFont.DrawText2DCenter(screenCenter + boxW, 105, 12, Strings::Get("taskmanager_objectives"));
  g_gameFont.SetRenderShadow(false);
...
void TaskManagerInterfaceIcons::RenderQuickUnit()
{
  ...
  float iconSize = 110;
  float iconX = (ClientEngine::OutputSize().Width / 2.0f);
  float iconY = ClientEngine::OutputSize().Height - iconSize;
  float iconAlpha = 0.9f;
