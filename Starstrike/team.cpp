...
Entity *Team::RayHitEntity(LegacyVector3 const &_rayStart, LegacyVector3 const &_rayEnd)
{
	// Hit against Units
...
Unit *Team::NewUnit(int _troopType, int _numEntities, int *_unitId, LegacyVector3 const &_pos)
{
