...
const char* Callsign::GetCallsign(int IFF)
{
  if (callsign_index < 0)
  ...
  {
    case 0:
      return civilian_catalog[callsign_index++];
    default: case 1:
      return alliance_catalog[callsign_index++];
    case 2:
      return hegemony_catalog[callsign_index++];
    case 3:
      return pirate_catalog[callsign_index++];
    case 4:
      return zolon_catalog[callsign_index++];
  }
}
