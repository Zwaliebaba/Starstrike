...
{
#ifdef TARGET_DEBUG
    LegacyVector3 unitPosition;
    LegacyVector3 entityPosition;
    LegacyVector3 laserPosition;
    LegacyVector3 effectsPosition;
    ...
    LegacyVector3 position = unitPosition + entityPosition + laserPosition + effectsPosition;
