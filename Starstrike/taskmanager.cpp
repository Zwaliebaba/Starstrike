...
void Task::Target( LegacyVector3 const &_pos )
{
    switch( m_type )
    {
...
void Task::TargetSquad( LegacyVector3 const &_pos )
{
...
void Task::TargetEngineer( LegacyVector3 const &_pos )
{
    int teamId = g_app->m_globalWorld->m_myTeamId;
...
void Task::TargetArmour( LegacyVector3 const &_pos )
{
#ifndef DEMOBUILD
    int teamId = g_app->m_globalWorld->m_myTeamId;
...
WorldObjectId Task::FindDarwinian( LegacyVector3 const &_pos )
{
    int teamId = g_app->m_globalWorld->m_myTeamId;
...
void Task::TargetOfficer( LegacyVector3 const &_pos )
{
    int teamId = g_app->m_globalWorld->m_myTeamId;
...
bool TaskManager::TargetTask( int _id, LegacyVector3 const &_pos )
{
...
bool TaskManager::IsValidTargetArea( int _id, LegacyVector3 const &_pos )
{
