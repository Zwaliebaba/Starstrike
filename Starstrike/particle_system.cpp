...
// *** Initialise
void Particle::Initialise(LegacyVector3 const &_pos, LegacyVector3 const &_vel,
...
// *** CreateParticle
void ParticleSystem::CreateParticle(LegacyVector3 const &_pos, LegacyVector3 const &_vel,
