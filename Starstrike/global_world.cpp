...
void ColorShapeFragment(ShapeFragment* _frag, const RGBAColor& _colour)
{
  if (_frag->m_numColors == 0)
    _frag->m_colours = new RGBAColor[1];
  ...
  for (int i = 0; i < _frag->m_childFragments.Size(); ++i)
    ColorShapeFragment(_frag->m_childFragments[i], _colour);
}
