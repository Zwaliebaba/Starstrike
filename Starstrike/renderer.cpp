...
void Renderer::Get2DScreenPos(LegacyVector3 const &v, LegacyVector3 *_out)
{
    double out[4];
...
void Renderer::RasteriseSphere(LegacyVector3 const &_pos, float _radius)
{
	...
	LegacyVector3 const camUpRight = (cam->GetRight() + cam->GetUp()) * _radius;
