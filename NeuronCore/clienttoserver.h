...
public:
    ...
    void RequestCreateUnit      ( unsigned char _teamId, unsigned char _troopType, int _numToCreate, LegacyVector3 const &_pos );
    void RequestAimBuilding     ( unsigned char _teamId, int _buildingId, LegacyVector3 const &_pos );
    void RequestToggleFence     ( int _buildingId );
    void RequestRunProgram      ( unsigned char _teamId, unsigned char _program );
    void RequestTargetProgram   ( unsigned char _teamId, unsigned char _program, LegacyVector3 const &_pos );
