...
class ControlBindings
{
  ...
  public:
    ...
    static controltype_t getControlID(const std::string& name);
    ...
    void setIcon(controltype_t id, const std::string& iconfile);

    // Associate an InputSpec with a control type, returning true on success
    bool bind(controltype_t type, const InputSpec& spec, bool replace = false);
